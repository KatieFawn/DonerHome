...
/**
 * Listener for handling the click event to navigate back to the BurgerActivity.
...
public class BackToBurgerListener implements View.OnClickListener {
    ...
    public void onClick(View view) {
        Log.d("BackToBurgerListener", "Button clicked, starting BurgerActivity.");
        replaceActivity();
    }
    ...
    private void replaceActivity(){
        ...
        Log.d("BackToBurgerListener", "Intent created to start BurgerActivity.");
